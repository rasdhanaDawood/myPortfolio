export const Contact = () => {
    ...
    return (
        <section id='contact' data-aos='fade-up' data-aos-delay='400'>
            ...
            <h2 className="mb-4 text-4xl tracking-tight font-title font-extrabold text-center text-white">Contact Me</h2>
            <form action='#' className="space-y-8">
                ...
                <button className="inline-flex text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 hover:shadow-[0_0_40px_rgba(255,165,0,0.7)] rounded-full text-lg">Send Message</button>
            </form>
        </div>
        </section>
    )
